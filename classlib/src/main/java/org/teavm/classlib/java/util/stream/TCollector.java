...
public interface TCollector<T, A, R> {
    ...
    static <T, A, R> TCollector<T, A, R> of(
            Supplier<A> supplier,
        ...
        return new TCollectorImpl<>(supplier, accumulator, combiner, finisher, characteristics);
    }

    static <T, R> TCollector<T, R, R> of(
            Supplier<R> supplier,
        ...
        Objects.requireNonNull(combiner);
        Objects.requireNonNull(characteristics);
        return new TCollectorImpl<T, R, R>(
